...
interface ComplexContextType {
  ...
  hasComplex: boolean;
  isAdmin: boolean;
  joinWithInviteCode: (inviteCode: string) => Promise<{ id: string; name: string }>;
  createNewComplex: (name: string) => Promise<Complex>;
  leave: () => Promise<void>;
  refresh: () => Promise<void>;
}

const ComplexContext = createContext<ComplexContextType | null>(null);
